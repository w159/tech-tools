...
Read the rendered result before handing it over - measured, not assumed (`references/preview.md` owns that check). A stylesheet that should produce 4.5:1 and a screen that does are different claims.
