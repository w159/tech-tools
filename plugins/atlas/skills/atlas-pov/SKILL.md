...
`general-purpose` subagents as peers, the typesafe/Jev MCP connector as an optional
different-model supplement, and `${CLAUDE_PLUGIN_ROOT}/scripts/atlas_finding.py` to stamp a durable verdict into
