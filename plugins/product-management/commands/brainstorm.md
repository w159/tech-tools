...
|  [OK] Explore problem spaces and opportunity areas             |
|  [OK] Generate and challenge product ideas                     |
|  [OK] Stress-test assumptions and strategies                   |
|  [OK] Apply PM frameworks (HMW, JTBD, First Principles, etc.) |
|  [OK] Capture key ideas, next steps, and open questions        |
+----------------------------------------------------------------+
